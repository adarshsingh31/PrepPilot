    ...
    <div className="antialiased min-h-screen bg-white text-gray-900 font-sans relative">
      ...
      <div className="relative z-10">
        ...
        <header className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-md shadow-sm border-b border-gray-100">
          <nav className="flex justify-between items-center px-6 py-4 max-w-7xl mx-auto">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link
                to="/signup"
                className="bg-primary text-white px-6 py-2.5 rounded-lg font-medium hover:bg-primary-container transition-all active:scale-95"
              >
                Sign up
              </Link>
            </div>
        ...
        <main className="pt-20">
          ...
          <section
            id="home"
            className="hero-bg-gradient pt-16 pb-24 overflow-hidden"
          >
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-left">
                ...
                <p className="text-lg text-gray-600 mb-10 max-w-lg leading-relaxed">
                  Practice coding interviews, analyze your resume, track your
                  progress, and prepare smarter with AI-driven insights.
                </p>

                <div className="flex flex-wrap gap-4 mb-10">
                  <Link
                    to="/signup"
                    className="bg-primary text-white px-8 py-3.5 rounded-lg font-bold flex items-center gap-2 hover:bg-primary-container transition-all group"
                  >
                    Get Started
                    <svg
                  ...
                  <a
                    href="#features"
                    className="bg-white border-2 border-indigo-100 text-primary px-8 py-3.5 rounded-lg font-bold hover:bg-indigo-50 transition-all flex items-center"
                  >
                    Learn More
                  </a>
                </div>
                ...
                <div className="flex items-center gap-4">
                  <div className="flex -space-x-3">
                    <img
                      ...
                      src="https://lh3.googleusercontent.com/aida-public/AB6AXuArIBEiNmQ8dpvxxX38Qtkdd1iQ55Y0aKYvNJd0BhDEO0zHKBNrl1fL0011dv_CYXyzF-oWnt-lKwx3MRa05VlseAfTtIM6WKmUBc0yGqTXR07LrGwEzE6PVCUn8z2whopauusD9Mlp9DR6R52Z_65jdsLMeSUU9TSLpVkvXV4i1hl8rb9LFa9V2XRic9ZcfCC3I_duyEYV7fOwn6s3TQfPbSW4QN7TXSBEVU4IKi37EgqJWErs0S4F_lJO13zQatmvs-l1lL1F3Uk"
                    />
                    <img
                      alt="User"
                      className="w-10 h-10 rounded-full border-2 border-white object-cover"
                      src="https://lh3.googleusercontent.com/aida-public/AB6AXuDBU-07AzDm8WKgz_GLne7DLXRXGc1wr27h6i3sTqFisHuUrWis0yfBI7xj9qA-LggxoYmjazKU9GJ9VjvDegqaYj7SK1W9r_RyttiRvwHFE2B3IpyOKX4DieJuKgauewebPEbpBEYACYK06ytviDVTe63vTCCVkMsv-RGQgEViCIkvrHPkaQzbjt9TA-AtLu3csuMWyftQU8SjtPY_GC_ro2hfnkEKgKLd8igjPaTnMq48mrNXGMDYAxbs7Uwwp-_Y1zxwrP_jkMw"
                    />
                    <img
                      alt="User"
                      className="w-10 h-10 rounded-full border-2 border-white object-cover"
                      src="https://lh3.googleusercontent.com/aida-public/AB6AXuAo4vLIIu-Jgrj9eP3Ozr8H2GjSNsM7D94BrSvZOxUDPDomQeYb-eUzXqgJN3CHDAOrkl0bwXrZ9usYlqsZTeiFEKvLPUZuJuKtX1GHLn3lj462NW109mY9rLyepTwH4621nDUdRjR7d9983TgxcrVtMntwxS2bDL1u_2t7-MDh74qzEGnlGX-RiKGgPGMa93pZQarkcKys6Dz4zLsEr-CXR3tRBGhwgvNxPhPEExdUWgqKB9lcQbLxDvgNsQtyt3fUPRyOxFij-x8"
                    />
                    <img
                      alt="User"
                      className="w-10 h-10 rounded-full border-2 border-white object-cover"
                      src="https://lh3.googleusercontent.com/aida-public/AB6AXuCXPK-WTrFIJu72_lzN4lQo-aH5uBlp-y2e7K53S5ThHncyT4Rzi1HcyOtP31IXnoPDnPn_iF74VLxHkwC7KR4AOuOHta9hS6DmmI7RHidjbuPA7_9K3ZavZa-izbG7A9kiRKe4074iXfi-IVU0MOWEvDqrzy0PNjsdTWjQfrBo4DC5S7xFpDclZysGR8GjRo_JIqswia4CDnXHXK_kY0lfYB7oc4bhoRrTimI5ycDhvQmiuetAWdItEn_EuT_PlOjG_xPdN99tzw0"
                    />
                  </div>
          ...
          <section id="features" className="py-24">
            <div className="max-w-7xl mx-auto px-6 text-center">
              <span className="text-primary font-bold text-xs uppercase tracking-widest mb-4 inline-block">
                Features
              </span>
              ...
              <p className="text-gray-500 mb-16 max-w-2xl mx-auto">
                Powerful tools to help you prepare, practice and get hired.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="p-8 rounded-2xl border border-gray-100 card-shadow hover:border-primary/20 transition-all text-left">
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed">
                    Practice real-time interviews with AI and get instant
                    feedback.
                  </p>
                </div>
                ...
                <div className="p-8 rounded-2xl border border-gray-100 card-shadow hover:border-primary/20 transition-all text-left">
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed">
                    Get AI-powered feedback to improve your resume and stand
                    out.
                  </p>
                </div>
                ...
                <div className="p-8 rounded-2xl border border-gray-100 card-shadow hover:border-primary/20 transition-all text-left">
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed">
                    Track your progress and identify your strengths &
                    weaknesses.
                  </p>
                </div>
                ...
                <div className="p-8 rounded-2xl border border-gray-100 card-shadow hover:border-primary/20 transition-all text-left">
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed">
                    Solve coding questions and improve with intelligent hints.
                  </p>
                </div>
                ...
                <div className="p-8 rounded-2xl border border-gray-100 card-shadow hover:border-primary/20 transition-all text-left">
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed">
                    Access a vast collection of interview questions curated by
                    experts.
                  </p>
                </div>
                ...
                <div className="p-8 rounded-2xl border border-gray-100 card-shadow hover:border-primary/20 transition-all text-left">
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed">
                    Get a personalized study plan based on your goals and
                    timeline.
                  </p>
                </div>
              </div>
            ...
            <div className="max-w-7xl mx-auto px-6">
              <div className="text-center mb-16">
                ...
                <p className="text-gray-500 max-w-xl mx-auto">
                  Start your journey and get interview-ready in no time.
                </p>
              </div>
              ...
              <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-24">
                ...
                <div className="flex flex-col items-center text-center relative group">
                  <div className="w-16 h-16 bg-primary text-white rounded-full flex items-center justify-center font-bold text-xl mb-6 shadow-lg z-10">
                    1
                  </div>
                  <div className="p-8 bg-white rounded-2xl card-shadow w-72">
                    ...
                    <p className="text-sm text-gray-500">
                      Sign up for free and set up your profile in just a few
                      seconds.
                    </p>
                  </div>
                  {/* Arrow */}
                ...
                <div className="flex flex-col items-center text-center relative group">
                  ...
                  <div className="p-8 bg-white rounded-2xl card-shadow w-72">
                    ...
                    <p className="text-sm text-gray-500">
                      Take AI mock interviews, solve coding problems, and
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="p-8 bg-white rounded-2xl card-shadow w-72">
                    ...
                    <p className="text-sm text-gray-500">
                      Track your progress, improve continuously, and crack your
                      dream job.
                    </p>
                  </div>
                </div>
          ...
          <section id="testimonials" className="py-24 overflow-hidden">
            <div className="max-w-7xl mx-auto px-6">
              <div className="text-center mb-16">
                ...
                <h2 className="text-4xl font-bold text-gray-900 mb-4">
                  Loved by Learners, Proven by Results
                </h2>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="p-8 rounded-2xl bg-white border border-indigo-50 card-shadow flex flex-col justify-between h-full text-left">
                  <div>
                    ...
                    <p className="text-gray-600 mb-8 italic">
                      "PrepPilot's AI mock interviews helped me identify my weak
                      areas. I felt confident and cracked my dream job!"
                    </p>
                  </div>
                ...
                <div className="p-8 rounded-2xl bg-white border border-indigo-50 card-shadow flex flex-col justify-between h-full text-left">
                  <div>
                    ...
                    <p className="text-gray-600 mb-8 italic">
                      "The resume analyzer is a game-changer. I improved my
                      resume score from 60 to 90 and started getting more
                      callbacks."
                    </p>
                  </div>
                  <div className="flex items-center gap-4 border-t border-gray-50 pt-6">
                    <img
                      alt="Rohit Verma"
                      className="w-12 h-12 rounded-full object-cover"
                      src="https://lh3.googleusercontent.com/aida-public/AB6AXuChwV_BDBTRqf18ULfBxzX5Vsr3LcB74vuyF0eN0n_f89nsAcM3CXXml6nH7mpXBH9cc_chijaq5OdQ69JdyZjYpM2kVqIzjtuBbDcXrAvIExn7ikcDZp3I9kXFVSOpLoZh1_gKXWo8nx8C0gc1daLb7hARpVZDTWGp5qweT-EzALYyW3qbA-0RGoWLST5ICiFieYaMqHF4npkpDueQJCrdCIANNVvF4OoJVrZcRIzQ1dwx2Bb_yOS7Vn5YVOQTAMJtgCMvC0ciw-0"
                    />
                    <div>
                ...
                <div className="p-8 rounded-2xl bg-white border border-indigo-50 card-shadow flex flex-col justify-between h-full text-left">
                  <div>
                    ...
                    <p className="text-gray-600 mb-8 italic">
                      "The personalized study plan kept me consistent. Highly
                      recommended for anyone serious about placements."
                    </p>
                  </div>
                  <div className="flex items-center gap-4 border-t border-gray-50 pt-6">
                    <img
            ...
            <div className="bg-primary rounded-3xl p-12 text-center text-white relative overflow-hidden">
              <div className="relative z-10">
                ...
                <p className="text-indigo-100 mb-10 max-w-lg mx-auto">
                  Join thousands of students who are already preparing smarter
                  with PrepPilot.
                </p>
                ...
                <div className="flex flex-wrap justify-center gap-4">
                  <Link
                    to="/signup"
                    className="bg-white text-primary px-8 py-3.5 rounded-lg font-bold flex items-center gap-2 hover:bg-gray-100 transition-all"
                  >
                    Start for Free
                    <svg
                      className="w-5 h-5"
                  ...
                  <a
                    href="#features"
                    className="bg-transparent border-2 border-indigo-300 text-white px-8 py-3.5 rounded-lg font-bold hover:bg-white/10 transition-all flex items-center"
                  >
                    Explore Features
                  </a>
                </div>
